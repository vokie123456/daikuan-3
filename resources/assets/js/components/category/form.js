            ...
            <Form className="formStyle" onSubmit={this.handleSubmit}>
                ...
                >
                    {getFieldDecorator('type', {
                        ...
                        <Select 
                            disabled={this.type_id == 1 ? true : false}
                        >
                            <Option value={0}>首页</Option>
                            {this.type_id == 1 ? <Option value={1}>首页图标</Option> : null}
                            <Option value={2}>贷款</Option>
                            <Option value={3}>秒放款</Option>
                        </Select>
                    )}
                </FormItem>
                {this.type_id == 1 ? 
                ...
                >
                    {getFieldDecorator('sort_app', {
                        ...
                        <Select>
                            ...
                            <Option value={2}>序号降序</Option>
                            <Option value={3}>序号升序</Option>
                        </Select>
                    )}
                </FormItem>
                <FormItem
